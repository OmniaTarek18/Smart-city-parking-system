...
const LotForm = ({ open, onClose, onSubmit, initialData }) => {
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={4}>
            ...
            <Slider
              ...
              onChange={(_, value) => handleChange('capacity', { ...formData.capacity, regular: value })}
              min={0}
              max={100}
          ...
          <Grid item xs={4}>
            ...
            <Slider
              ...
              onChange={(_, value) => handleChange('capacity', { ...formData.capacity, disabled: value })}
              min={0}
              max={20}
              valueLabelDisplay="auto"
            />
          ...
          <Grid item xs={4}>
            ...
            <Slider
              ...
              onChange={(_, value) => handleChange('capacity', { ...formData.capacity, evCharging: value })}
              min={0}
              max={30}
              valueLabelDisplay="auto"
            />
          ...
          <Grid item xs={6}>
            <TextField
              ...
              error={hasError('baseRate')}
              helperText={hasError('baseRate') ? errors.baseRate : ''}
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <AttachMoney />
          ...
          <Grid item xs={6}>
            <TextField
              ...
              value={formData.pricing.congestionRate}
              onChange={(e) => handleChange('pricing', {
                ...formData.pricing,
                congestionRate: parseFloat(e.target.value)
              })}
              error={hasError('congestionRate')}
              helperText={hasError('congestionRate') ? errors.congestionRate : ''}
              InputProps={{
